...
function CreatePost() {
        const navigate = useNavigate() //to navigate from create post to home page
        ...
        const generateImage = async () => {
                if (form.prompt) {
                        try {
                                ...
                                const response = await fetch('https://ai-image-generator-ua5s.onrender.com/api/v1/dalle', {
                                        method: 'POST',
                                        headers: {
        ...
        const handleSubmit = async (e) => {
                ...
                if (form.prompt && form.photo) {
                        setLoading(true);
                        try {
                                const response = await fetch('https://ai-image-generator-ua5s.onrender.com/api/v1/posts', {
                                        method: 'POST',
                                        headers: {
                                                'Content-Type': 'application/json',
                                        },
        ...
        return (
                <section>
                        <div>
                                ...
                                max-w[500px]'>Create a mesmerizing
                                        and artistically designed AI-generated visuals and
                        ...
                        <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
                                <div className='flex flex-col gap-5'>
                                        ...
                                        border-gray-900 text-gray-900 text-sm rounded-lg
                                        focus:ring-orange-500 focus:border-orange-500 w-64 p-3
