                        ...
                        p-4 rounded-md'>
                                ...
                                gap-2'>
                                        <div className='flex items-center gap-2'>
                                                ...
                                                <p className='text-white text-sm font-bold'>{props.name}</p>
                                        </div>
                                        <button type='button' onClick={() => downloadImage
                                                (props._id, props.photo)} className='outline-none bg-transparent
                                                border-none'>
